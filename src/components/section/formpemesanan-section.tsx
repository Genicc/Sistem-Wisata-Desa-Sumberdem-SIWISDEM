    ...
    return (
        <section
            ...
            <div className=" max-w-5xl px-6 py-14 mt-25">
                ...
                <form
                    onSubmit={onSubmit}
                    className="mt-8 text-white/95 max-w-3xl space-y-6"
                    >
                    {/* Nama */}
                    <div>
                    ...
                    <div className="flex flex-col gap-4 pt-2 md:flex-row md:items-center md:justify-between">
                        <button
                        type="submit"
                        className="px-6 py-3 rounded-full bg-white text-[#2f6c2f] font-semibold shadow hover:opacity-90 transition"
                        >
                        Kirim Pemesanan
                        </button>
