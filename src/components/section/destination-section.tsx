    ...
    return (
        ...
        <div className="relative z-10 max-w-3xl px-5 flex flex-col items-center space-y-4 -mt-10">
            ...
            <p className={`${lato.className} text-white text-base md:text-2xl leading-relaxed font-medium -mt-15`}>
                Nikmati pengalaman wisata edukatif di kampung tematik sumberdem berbasis potensi lokal :{" "}
                <span className="font-semibold">Kopi, Lemon, Rosella, KRPL dan Ternak</span>.  
                <span> Setiap kampung punya cerita unik untuk anda jelajahi. </span>
            </p>
        </div>
